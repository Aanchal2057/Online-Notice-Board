...
if(!empty ($_POST)){
    ...
    //var_dump($userdata);
    $result = mysqli_query($link," select * from superadmin where id='$userdatanew[id]'");//
...
//    print_r($data);
    ...
    else
    {
        if ($newpassword == $confirmnewpassword) {
            ...
            $sql = mysqli_query($link,"UPDATE superadmin SET password='$newpassword' where id='$userdatanew[id]'");
